...
v yay -Rns hyprland-git illogical-impulse-{audio,backlight,basic,fonts-themes,gnome,gtk,microtex-git,portal,pymyc-aur,python,screencapture,widgets,agsv1,bibata-modern-classic-bin} plasma-browser-integration
