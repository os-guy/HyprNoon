...
export const download = Widget.Box({ hexpand:true, children: [downloadIcon, downloadLabel] });
export const upload = Widget.Box({ hexpand:true, children: [uploadIcon, uploadLabel] });
